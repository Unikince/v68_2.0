...
public class IPSeeker {
	private static String projectPath = FileUtil.getProjectPath();
	// 纯真IP数据库名
	private String IP_FILE = projectPath + "/config/ip/qqwry.dat";
	// 保存的文件夹
	private String INSTALL_DIR = projectPath + "/config/ip/qqwry";
	...
	public IPSeeker() {
		...
		// System.out.println("IP_FILE:"+IP_FILE+",INSTALL_DIR:"+INSTALL_DIR);
