...
import com.dmg.redblackwarserver.common.exception.ScoketBusinessException;
...
import com.dmg.redblackwarserver.common.utils.WebsocketUtil;
...
//	private static CityCacheService cityCacheService;
//	@Autowired
//	public void setCityCacheService(CityCacheService cityCacheService) {
//		MyWebSocket.cityCacheService = cityCacheService;
//	}
...
//		String city = this.getCity("171.212.184.252");
...
//		String city = cityCacheService.getCity(ip);
...
//			city = "未知";
//			cityCacheService.saveCity(ip,city);
//			return city;
//		}
//		String url = "http://api.map.baidu.com/location/ip?ip=" + ip + "&ak=DDlrTGBfKmhzyfZB6nXssTOPrHYCCnqO";
//		try {
//			String result = "";
//			URL u = new URL(url);
...
//				result += "\n" + line;
//			}
//			JSONObject string = JSON.parseObject(result);
//			JSONObject json = string.getJSONObject("content");
//			if (json != null) {
//				JSONObject detail = json.getJSONObject("address_detail");
//				city = detail.getString("city");
//				cityCacheService.saveCity(ip,city);
//				return city;
//			}
//		} catch (MalformedURLException e) {
//			log.error("Baidu解析ip出错", e);
//			e.printStackTrace();
//		} catch (IOException e) {
//			log.error("Baidu解析ip出错", e);
//			e.printStackTrace();
