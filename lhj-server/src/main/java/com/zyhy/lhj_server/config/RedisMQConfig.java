...
public class RedisMQConfig {
	...
	RedisMessageListenerContainer container(LettuceConnectionFactory connectionFactory,
		...
		//订阅一个叫mq_01 的信道
		container.addMessageListener(listenerAdapter, new PatternTopic(RedisRegionConfig.UPDATE_LHJ_GAME_CONFIG_CHANNEL));
	...
	MessageListenerAdapter listenerAdapter(MessageReceiver receiver) {
		...
		return new MessageListenerAdapter(receiver, "updateLhjGameConfig"); //receiveMessage：接收消息的方法名称
	}
