...
@Order
@Component
public class FkmjUserLoginProcess extends AbstractHttpMsgProcess{
	...
	public int getMessageId() {
		return MessageConstants.FKMJ_USER_APPLY_LOGIN;
	}
...
//		CommonLog.getInstance(restTemplate).createUserLhjLog(LogType.LOGIN_ZCTZ, ZctzConstants.SERVER_NAME, user.getRoleId(), user.getNickname(), result.getGold());
		...
		UserLhjLog log = UserLhjLog.build(Constants.FKMJ_SERVER_NAME, "login", roleid, user.getNickname(), user.getGold());
