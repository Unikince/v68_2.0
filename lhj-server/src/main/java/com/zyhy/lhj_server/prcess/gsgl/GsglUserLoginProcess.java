...
@Order
@Component
public class GsglUserLoginProcess extends AbstractHttpMsgProcess{
	...
	public int getMessageId() {
		return MessageConstants.GSGL_USER_APPLY_LOGIN;
	}
...
//		CommonLog.getInstance(restTemplate).createUserLhjLog(LogType.LOGIN_GSGL, GsglConstants.SERVER_NAME, user.getRoleId(), user.getNickname(), result.getGold());
		
		UserLhjLog log = UserLhjLog.build(Constants.GSGL_SERVER_NAME, "login", roleid, user.getNickname(), user.getGold());
