...
@Order
@Component
public class YhddUserLoginProcess extends AbstractHttpMsgProcess{
	...
	public int getMessageId() {
		return MessageConstants.YHDD_USER_APPLY_LOGIN;
	}
...
//		CommonLog.getInstance(restTemplate).createUserLhjLog(LogType.LOGIN_GSGL, GsglConstants.SERVER_NAME, user.getRoleId(), user.getNickname(), result.getGold());
		...
		UserLhjLog log = UserLhjLog.build(Constants.YHDD_SERVER_NAME, "login", roleid, user.getNickname(), user.getGold());
