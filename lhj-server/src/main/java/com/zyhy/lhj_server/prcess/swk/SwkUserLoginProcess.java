...
@Order
@Component
public class SwkUserLoginProcess extends AbstractHttpMsgProcess{
	...
	public int getMessageId() {
		return MessageConstants.SWK_USER_APPLY_LOGIN;
	}
...
//		CommonLog.getInstance(restTemplate).createUserLhjLog(LogType.LOGIN_ZCTZ, ZctzConstants.SERVER_NAME, user.getRoleId(), user.getNickname(), result.getGold());
		...
		UserLhjLog log = UserLhjLog.build(Constants.SWK_SERVER_NAME, "login", roleid, user.getNickname(), user.getGold());
