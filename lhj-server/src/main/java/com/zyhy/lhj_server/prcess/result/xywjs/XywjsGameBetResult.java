 ...
 *
 */
public class XywjsGameBetResult extends HttpMessageResult{
	...
	public String toString() {
		return "ZctzGameBetResult [windowinfos=" + windowinfos + ", winrouteinfos="
				+ winrouteinfos + ", usercoin=" + usercoin + ", rewardcoin="
				+ rewardcoin + ", poolGame=" + poolGame + "]";
	}
