...
@Order
@Component
public class AlsjUserLoginProcess extends AbstractHttpMsgProcess{
	@Autowired
	...
	public int getMessageId() {
		return MessageConstants.ALSJ_USER_APPLY_LOGIN;
	}
	...
	public HttpMessageResult handler(String uuid, Map<String, String> body)
		...
		UserLhjLog log = UserLhjLog.build(Constants.ALSJ_SERVER_NAME, "login", roleid, user.getNickname(), user.getGold());
