...
@Order
@Component
public class ZctzUserLoginProcess extends AbstractHttpMsgProcess{
	@Autowired
	private BgManagementServiceImp bgManagementServiceImp;
	@Autowired
	private UserService userService;
	private static final Logger LOG = LoggerFactory.getLogger(ZctzUserLoginProcess.class);
	@Override
	public int getMessageId() {
		return MessageConstants.ZCTZ_USER_APPLY_LOGIN;
	}
