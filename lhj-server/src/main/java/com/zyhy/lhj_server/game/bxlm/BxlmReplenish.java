 ...
 */
public class BxlmReplenish {
	//下注信息
	private BetInfo betInfo;
	//是否补充数据
	private boolean isBxlmReplenish;
	//补充的地图
//	private List<List<WindowInfo>> wininfo = new ArrayList<List<WindowInfo>>();
	...
	public BxlmReplenish(BetInfo betInfo){
		this.betInfo = betInfo;	
	}
	public BxlmReplenish(){
...
//	}
	...
	public String toString() {
		return "BxlmReplenish [betInfo=" + betInfo + ", isBxlmReplenish=" + isBxlmReplenish + ", isFree=" + isFree
