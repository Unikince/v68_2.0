 ...
 *
 */
public enum FkmjBetEnum implements Bet{
	...
	private FkmjBetEnum(int id, double betcoin) {
		this.id = id;
	...
	public static FkmjBetEnum getById(int id) {
		for(FkmjBetEnum v : values()){
			if(v.getId() == id){
				return v;
			}
		}
	...
	public static FkmjBetEnum getByBetcoin(double jetton) {
		for(FkmjBetEnum v : values()){
