...
//	private List<List<WindowInfo>> wininfo = new ArrayList<List<WindowInfo>>();
	...
	public BqtpReplenish(BetInfo betInfo){
		this.betInfo = betInfo;	
	}
	public BqtpReplenish(){
...
//	}
	...
	public String toString() {
		return "BqtpReplenish [betInfo=" + betInfo + ", isReplenish=" + isReplenish + ", isFree=" + isFree + ", number="
				+ number + ", wild=" + wild + "]";
	}
