...
//	private List<List<WindowInfo>> wininfo = new ArrayList<List<WindowInfo>>();
	...
	public FkmjReplenish(BetInfo betInfo){
		this.betInfo = betInfo;	
	}
	public FkmjReplenish(){
...
//	}
	...
	public String toString() {
		return "FkmjReplenish [betInfo=" + betInfo + ", isReplenish=" + isReplenish + ", isFree=" + isFree + ", number="
				+ number + ", wild=" + wild + "]";
	}
