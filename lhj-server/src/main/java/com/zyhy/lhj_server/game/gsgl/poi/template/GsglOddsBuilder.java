...
import com.zyhy.lhj_server.game.gsgl.poi.impl.BaseXlsTemplateBuilder;
 ...
 *
 */
public class GsglOddsBuilder implements BaseXlsTemplateBuilder {

	@Override
	public TemplateObject buildTemplate(Row row) {
		GsglOdds f = new GsglOdds();
