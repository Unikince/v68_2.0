...
public class SwkScatterInfo {
	...
	public SwkScatterInfo(){}
	
	public SwkScatterInfo(BetInfo betInfo){
	...
	public String toString() {
		return "SwkScatterInfo [betInfo=" + betInfo + ", betLine=" + betLine + ", num=" + num + ", model=" + model
				+ ", gold=" + gold + "]";
	}
