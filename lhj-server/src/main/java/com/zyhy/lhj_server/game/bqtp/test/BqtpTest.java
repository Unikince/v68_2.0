package com.zyhy.lhj_server.game.bqtp.test;
...
public class BqtpTest {
	...
	public  void initTest() throws IOException, InterruptedException {
		...
		String path = "C:\\Users\\Administrator\\Desktop\\shuzhi\\bqtp\\1";
		String name = "bqtp-" + format +".txt";
		File file = new File(path, name);
		System.out.println(file.createNewFile());
		for (int i = 1; i <= round; i++) {
			String testLogin1 = testLogin();
			BqtpResult result = testAuto();
	 ...
	 */
	public  BqtpResult testAuto() throws InterruptedException{
		// 统计结果
		BqtpResult yzhxResult = new BqtpResult();
		// 开始测试
