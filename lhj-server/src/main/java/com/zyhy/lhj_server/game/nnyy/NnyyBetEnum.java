 ...
 *
 */
public enum NnyyBetEnum implements Bet{
	a(0,0),
	b(1,0),
	c(2,0),
	d(3,0),
	...
	NnyyBetEnum(int id, double betcoin){
		this.id = id;
	...
	public static NnyyBetEnum getById(int id) {
		for(NnyyBetEnum v : values()){
			if(v.getId() == id){
				return v;
			}
		}
	...
	public static NnyyBetEnum getByBetcoin(double jetton) {
		for(NnyyBetEnum v : values()){
