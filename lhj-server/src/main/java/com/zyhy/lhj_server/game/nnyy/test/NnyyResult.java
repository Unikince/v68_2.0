...
public class NnyyResult {
	...
	public double getWildreward() {
		return wildreward;
	}

	public void setWildreward(double wildreward) {
		this.wildreward = wildreward;
	}
	...
	public String toString() {
		return "TestResult [总下注次数 =" + betCount 
				...
				+ ", 总投注金额 =" + totalBet 
				+ ", 正常游戏中奖次数 =" + totalCount
				+ ", 不包含WILD的奖励 =" + totalreward 
				+ ", 包含WILD的奖励 =" + wildreward 
				+ ", 免费游戏触发次数 =" + freeCount 
				+ ", 免费游戏总次数 =" + totoalFreeCount 
				+ ", 免费游戏总奖励 =" + freeGameReward 
				+ ", 中奖概率 =" + totalRewardlv 
				+ ", 收益率 ="+ totalIncomelv + "]";
	}
}
