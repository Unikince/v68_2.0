...
public class YzhxResult {
	...
	public String toString() {
		return "TestResult [总下注次数 =" + betCount + ", 总游戏次数 =" + gameCount + ", 总投注金额 =" + totalBet + ", 总中奖次数 =" + totalCount
				+ ", 正常游戏奖励 =" + totalreward + ", 免费游戏奖励 =" + freeGameReward + ", 中奖概率 =" + totalRewardlv + ", 收益率 ="
				+ totalIncomelv + "]";
	}
}
