 ...
 *
 */
public enum CzdbzBetEnum implements Bet{
	...
	CzdbzBetEnum(int id, double betcoin){
		this.id = id;
	...
	public static CzdbzBetEnum getById(int id) {
		for(CzdbzBetEnum v : values()){
			if(v.getId() == id){
				return v;
			}
		}
	...
	public static CzdbzBetEnum getByBetcoin(double jetton) {
		for(CzdbzBetEnum v : values()){
