...
@Order
//@Component
public class CloseAllSoltGameProcess extends AbstractHttpMsgProcess{
	@Autowired
	private BgManagementDaoImp bgManagementDaoImp;
	
	@Override
	public int getMessageId() {
		return SoltMessageConstants.COLSEALLSOLTGAME;
	}
	...
	public HttpMessageResult handler(String uuid, Map<String, String> body)
		...
		int update = bgManagementDaoImp.closeAllsoltGame();
		if (update <= 0) {
			result.setRet(2);
