...
public class AdvancedUtil {
	...
	public static WeixinOauth2Token getOauth2AccessToken(String appId, String appSecret, String code) {
		...
		if (null != jsonObject) {
			try {
				...
				logger.error("getOauth2AccessToken error:{},{}", jsonObject, e);
				wat = null;
			}
		}
		return wat;
	...
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
		...
		if (null != jsonObject) {
			logger.info("SNS info:{}", jsonObject);
			try {
				...
				snsUserInfo.setPrivilegeList(
						JSONArray.parseArray(jsonObject.getJSONArray("privilege").toString(), String.class));

			} catch (Exception e) {
				logger.error("getSNSUserInfo error:{},{}", jsonObject, e);
				snsUserInfo = null;
			}
		}
		return snsUserInfo;
