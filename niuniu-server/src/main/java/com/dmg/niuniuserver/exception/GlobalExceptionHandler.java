package com.dmg.niuniuserver.exception;

import com.dmg.niuniuserver.result.Result;
...
public class GlobalExceptionHandler {
    ...
    private Result methodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        return Result.error(ResultEnum.LESS_PARAMS.getCode()+"",ResultEnum.LESS_PARAMS.getMsg());
    }
